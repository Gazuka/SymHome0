...
// Returns the private 'App\Repository\BoiteRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\BoiteRepository.php';

return $this->privates['App\Repository\BoiteRepository'] = new \App\Repository\BoiteRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
