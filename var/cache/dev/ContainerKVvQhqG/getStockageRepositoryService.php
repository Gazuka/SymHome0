...
// Returns the private 'App\Repository\StockageRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\StockageRepository.php';

return $this->privates['App\Repository\StockageRepository'] = new \App\Repository\StockageRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
