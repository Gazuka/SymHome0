...
$a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Repository\\AlimentRepository' => function () {
    return ($this->privates['App\Repository\AlimentRepository'] ?? $this->load('getAlimentRepositoryService.php'));
}, 'App\\Repository\\BoiteRepository' => function () {
    return ($this->privates['App\Repository\BoiteRepository'] ?? $this->load('getBoiteRepositoryService.php'));
}, 'App\\Repository\\EtapeRepository' => function () {
...
}, 'App\\Repository\\PlatRepository' => function () {
    return ($this->privates['App\Repository\PlatRepository'] ?? $this->load('getPlatRepositoryService.php'));
...
}, 'App\\Repository\\RecetteRepository' => function () {
    return ($this->privates['App\Repository\RecetteRepository'] ?? $this->load('getRecetteRepositoryService.php'));
}, 'App\\Repository\\StockageRepository' => function () {
    return ($this->privates['App\Repository\StockageRepository'] ?? $this->load('getStockageRepositoryService.php'));
}, 'App\\Repository\\TypeAlimentRepository' => function () {
    return ($this->privates['App\Repository\TypeAlimentRepository'] ?? $this->load('getTypeAlimentRepositoryService.php'));
}))));
