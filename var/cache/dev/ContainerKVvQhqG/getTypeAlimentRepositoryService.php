...
// Returns the private 'App\Repository\TypeAlimentRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\TypeAlimentRepository.php';

return $this->privates['App\Repository\TypeAlimentRepository'] = new \App\Repository\TypeAlimentRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
